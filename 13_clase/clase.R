...
Bloques_rt = rep(c("b1", "b2", "b3", "b4", "b5", "b6", "b7", "b8", "b9", "b10"), each = 5)
...
boxplot(Respuestas_rt ~ Tratamientos_rt, col = c("#2FD9B7", "#B72FD9", "#D92F42", "#6FD92F", "#D9B02F"))

#bloxplot de respuesta-bloques

#No puedeo hacer analisis
boxplot(Respuestas_rt ~ Bloques_rt, col = c("#2FD9B7", "#B72FD9", "#D92F42", "#6FD92F", "#D9B02F", 
                                            "#64C8C5", "#6485C8", "#64C88D", "#C89664", "#64C866"))
...
summary(modelo_DCA_rt) #ver el mean Sq estes es varianza DCA = 0.04337
...
Porcentaje_reduccion = (0.00824 - 0.04337 )*100/0.04337 #reduccion al 80% del 
#error
